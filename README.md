...
This repository contains the datasets, code, and executed Jupyter Notebooks for Experiments 1 through 5 of the Data Analytics and Visualization Lab manual.

## Repository Structure

The project is organized into folders for each experiment:

```text
DAV_Lab/
├── .gitattributes             # Git attributes file
├── .gitignore                 # Git ignore file
├── DAV manual UPDATED.pdf     # Lab Manual
├── README.md                  # Project documentation
│
├── Experiment_1/              # Lab Environment Verification
│   ├── Experiment_1.ipynb     # Jupyter Notebook
│   └── experiment_1.py        # Python script
│
...
│   └── datasets               # CSV, Excel, and Iris datasets
│
